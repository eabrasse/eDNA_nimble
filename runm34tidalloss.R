...
model <- nimbleModel(code = m34tidalloss,
                     data = nimbleData,
...
save(nimbleOut, file = "./Results/nimbleOut_m34tidalloss.RData")

load("./Results/nimbleOut_m34tidalloss.RData")
...
write.csv(df, "./Results/m34tidalloss_plotting.csv")
