...
model <- nimbleModel(code = m32expdolphin,
                     data = nimbleData,
...
save(nimbleOut, file = "./Results/nimbleOut_m32expdolphin.RData")

load("./Results/nimbleOut_m32expdolphin.RData")
...
write.csv(df, "./Results/m32expdolphin_plotting.csv")
